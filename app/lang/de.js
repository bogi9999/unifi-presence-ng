export default {
  ...
  UNIFI: {
    ...
    CONTROLLER_AUTO_HINT: 'Der Controller-Modus wird automatisch erkannt (Port gesetzt = klassischer Controller, ohne Port = UniFi OS / Dream Machine).',
    TOPIC: 'MQTT Topic',
    TOPIC_HINT:
    ...
    MQTT_MODE: 'MQTT Modus',
    MQTT_MODE_HINT: 'Wähle LoxBerry MQTT oder einen eigenen Broker.',
    MQTT_MODE_LOXBERRY: 'LoxBerry MQTT',
    MQTT_MODE_CUSTOM: 'Eigener Broker',
    MQTT_HOST: 'MQTT Host',
    MQTT_PORT: 'MQTT Port',
