export default {
  ...
  UNIFI: {
    ...
    CONTROLLER_AUTO_HINT:
      'Controller mode is detected automatically (port set = classic controller, no port = UniFi OS / Dream Machine).',
    TOPIC: 'MQTT Topic',
    TOPIC_HINT:
    ...
    MQTT_MODE: 'MQTT Mode',
    MQTT_MODE_HINT: 'Choose LoxBerry MQTT or a custom broker.',
    MQTT_MODE_LOXBERRY: 'LoxBerry MQTT',
    MQTT_MODE_CUSTOM: 'Custom Broker',
    MQTT_HOST: 'MQTT Host',
    MQTT_PORT: 'MQTT Port',
